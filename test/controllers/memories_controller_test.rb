...
class MemoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memory" do
    assert_difference('Memory.count') do
      post memories_url, params: { memory: { description: @memory.description, memorial_id: @memory.memorial_id, published: @memory.published, user_id: @memory.user_id } }, as: :json
    end
  ...
  test "should update memory" do
    patch memory_url(@memory), params: { memory: { description: @memory.description, memorial_id: @memory.memorial_id, published: @memory.published, user_id: @memory.user_id } }, as: :json
    assert_response 200
  end
